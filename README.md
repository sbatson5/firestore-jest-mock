...
| `mockCreateCustomToken`              | Assert correct user ID and claims are passed. Returns a promise            | [setCustomToken](https://firebase.google.com/docs/reference/admin/node/admin.auth.Auth?hl=en#createcustomtoken)                        |
