...
| ------------------------------------ | -------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| `mockApplyActionCode`                | Apply an action code provided by another Auth function. Returns a promise  | [mockApplyActionCode](https://firebase.google.com/docs/reference/js/firebase.auth.Auth#applyactioncode)                                |
